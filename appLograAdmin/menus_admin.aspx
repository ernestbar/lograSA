												...
												<table id="data-table-default" class="table table-striped table-bordered">
													...
													<tbody>
														...
														<ItemTemplate>
															...
															<td>
																<asp:Button ID="btnEditar" style="color:blue" class="btn btn-success btn-sm"  CommandArgument='<%# Eval("COD_MENU") %>' OnClick="btnEditar_Click" runat="server" Text="Editar" ToolTip="Editar" />
																<asp:Button ID="btnEliminar" style="color:blue" class="btn btn-danger btn-sm" CommandArgument='<%# Eval("COD_MENU") +"|" +Eval("DESC_ESTADO") %>' OnClick="btnEliminar_Click"  runat="server" Text="Activar/Descativar" ToolTip="Activa o descativa registro" />
