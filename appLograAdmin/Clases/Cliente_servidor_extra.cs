...
{
    public class Cliente_servidor_extra
    {
        ...
        //    //PR_GET_CLIENTE();
        //}
        public Cliente_servidor_extra(string pV_COD_CLIENTE_SICI,string pV_DETALLE, string pV_COD_CLIENTE,
        ...
        public static DataTable PR_GET_CLIENTE_SERVIDOR_EXTRA(string pV_COD_CLIENTE, string pV_COD_SERVIDOR)
        {
            try
            {
                ...
                OracleCommand cmd = new OracleCommand("PAQ_SEG_CLIENTE_SERVEX_SIGAL.PR_GET_CLIENTE_SERVIDOR_EXTRA", Conexion);
        ...
        public static DataTable PR_GET_LISTAR_SICI(string pV_COD_CLIENTE, string pV_COD_SERVIDOR)
        {
            try
            {
                if (Conexion.State.ToString().ToUpper() == "CLOSED")
                ...
                OracleCommand cmd = new OracleCommand("PAQ_SEG_CLIENTE_SERVEX_SIGAL.PR_GET_LISTAR_SICI", Conexion);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("PV_COD_CLIENTE", OracleDbType.Varchar2, ParameterDirection.Input).Value = pV_COD_CLIENTE;
                cmd.Parameters.Add("PV_COD_SERVIDOR", OracleDbType.Varchar2, ParameterDirection.Input).Value = pV_COD_SERVIDOR;
                cmd.Parameters.Add("po_tabla", OracleDbType.RefCursor, ParameterDirection.Output);
        ...
        public static DataTable PR_GET_CLIENTE_SERVIDOR_E_IND(string pV_COD_CLIENTE, string pV_COD_SERVIDOR,string pV_COD_CLIENTE_SICI)
        {
            try
            {
                if (Conexion.State.ToString().ToUpper() == "CLOSED")
                ...
                OracleCommand cmd = new OracleCommand("PAQ_SEG_CLIENTE_SERVEX_SIGAL.PR_GET_CLIENTE_SERVIDOR_E_IND", Conexion);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("PV_COD_CLIENTE", OracleDbType.Varchar2, ParameterDirection.Input).Value = pV_COD_CLIENTE;
                cmd.Parameters.Add("PV_COD_SERVIDOR", OracleDbType.Varchar2, ParameterDirection.Input).Value = pV_COD_SERVIDOR;
                cmd.Parameters.Add("PV_COD_CLIENTE_SICI", OracleDbType.Varchar2, ParameterDirection.Input).Value = pV_COD_CLIENTE_SICI;
                cmd.Parameters.Add("po_tabla", OracleDbType.RefCursor, ParameterDirection.Output);
                cmd.ExecuteNonQuery();
                DataSet ds = new DataSet();
                OracleDataAdapter da = new OracleDataAdapter(cmd);
        ...
        public string ABM_I()
        {
            ...
            try
            {
                ...
                OracleCommand cmd = new OracleCommand("PAQ_SEG_CLIENTE_SERVEX_SIGAL.PR_I_CLIENTE_SERVIDOR_EXTRA", Conexion);
                cmd.CommandType = CommandType.StoredProcedure;
        ...
        public string ABM_U()
        {
            ...
            try
            {
                ...
                OracleCommand cmd = new OracleCommand("PAQ_SEG_CLIENTE_SERVEX_SIGAL.PR_U_CLIENTE_SERVIDOR_EXTRA", Conexion);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("PV_COD_CLIENTE_SICI", OracleDbType.Varchar2, ParameterDirection.Input).Value = _PV_COD_CLIENTE_SICI;
                cmd.Parameters.Add("PV_DETALLE", OracleDbType.Varchar2, ParameterDirection.Input).Value = _PV_DETALLE;
                cmd.Parameters.Add("PV_COD_CLIENTE", OracleDbType.Varchar2, ParameterDirection.Input).Value = _PV_COD_CLIENTE;
        ...
        public string ABM_D()
        {
            ...
            try
            {
                ...
                OracleCommand cmd = new OracleCommand("PAQ_SEG_CLIENTE_SERVEX_SIGAL.PR_D_CLIENTE_SERVIDOR_EXTRA", Conexion);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("PV_COD_CLIENTE_SICI", OracleDbType.Varchar2, ParameterDirection.Input).Value = _PV_COD_CLIENTE_SICI;
                cmd.Parameters.Add("PV_COD_CLIENTE", OracleDbType.Varchar2, ParameterDirection.Input).Value = _PV_COD_CLIENTE;
                cmd.Parameters.Add("PV_COD_SERVIDOR", OracleDbType.Varchar2, ParameterDirection.Input).Value = _PV_COD_SERVIDOR;
        ...
        public string ABM_A()
        {
            ...
            try
            {
                ...
                OracleCommand cmd = new OracleCommand("PAQ_SEG_CLIENTE_SERVEX_SIGAL.PR_A_CLIENTE_SERVIDOR_EXTRA", Conexion);
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("PV_COD_CLIENTE_SICI", OracleDbType.Varchar2, ParameterDirection.Input).Value = _PV_COD_CLIENTE_SICI;
                cmd.Parameters.Add("PV_COD_CLIENTE", OracleDbType.Varchar2, ParameterDirection.Input).Value = _PV_COD_CLIENTE;
                cmd.Parameters.Add("PV_COD_SERVIDOR", OracleDbType.Varchar2, ParameterDirection.Input).Value = _PV_COD_SERVIDOR;
