    ...
    <asp:MultiView ID="MultiView1" runat="server">
        <asp:View ID="View1" runat="server">
										...
										<!-- begin page-header -->
											...
											Fecha fin:
											<input id="fecha_retorno" class="form-control col-2"  style="background:#ecf1fa" type="date"><asp:HiddenField ID="hfFechaRetorno" runat="server" />
											<!-- end page-header -->
													...
													<tbody>
														...
														<ItemTemplate>
															...
															<td><asp:Label ID="Label1" runat="server" Text='<%# Eval("FECHASALIDA") %>'></asp:Label></td>
																...
																<td><asp:Label ID="Label7" runat="server" Text='<%# Eval("LOTE_MUNDO") %>'></asp:Label></td>
