...
namespace appLograAdmin
{
    public partial class reporte_ingresos : System.Web.UI.Page
    {
        ...
        {
            Repeater1.DataSource= Clases.Reportes.PR_INGRESOS(DateTime.Parse(hfFechaSalida.Value),DateTime.Parse(hfFechaRetorno.Value),ddlClientes.SelectedValue,ddlServidor.SelectedValue);
            Repeater1.DataBind();
        }
    }
}