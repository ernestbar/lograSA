<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="opcion_menu_rol_admin.aspx.cs" Inherits="appLograAdmin.opcion_menu_rol_admin" %>
	...
	<!-- begin #content -->
		<div id="content" class="content">
			...
			<!-- begin form-group row -->
										...
										<!-- begin page-header -->
											<h1 class="page-header">Asignación  de opciones a roles menús<small></small></h1>
										...
										<%--<div class="table-responsive">--%>
												<table id="data-table-default" class="table table-striped table-bordered">
													<thead>
														<tr>
															<th class="text-wrap">OPCIONES ROL MENU ASINGADO </th>
															<th class="text-nowrap">OPCIONES ROL MENU NO ASIGNADO</th>
														</tr>
													</thead>
													<tbody>
														<tr>
